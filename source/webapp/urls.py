...
from .views import (TaskView, UpdateView, DeleteView, IndexView, ProjectView, TaskCreate, ProjectCreate, DeleteProject, ProjectUpdate)
...
urlpatterns = [
    ...
    path('<int:pk>/update/project', ProjectUpdate.as_view(), name='project-update'),
